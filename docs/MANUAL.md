...
> (작성 시점 버전: marketplace `hunminkim`, project-init **v2.7.0**, harness-check **v1.0.1**, prompt-log **v1.1.1**)
>
...
| 플러그인 | 버전 | 한 줄 요약 |
|---------|------|----------|
| **project-init** | v2.7.0 | 본체. 프로젝트 스캐폴딩 + plan-gate + verifier + 21개 훅 + 18개 명령 |
